...
soysauce.togglers = (function() {
  ...
  function Toggler(selector, orphan) {
    ...
    if (this.slide) {
      ...
      this.allContent.css("data-ss-state", "open");
   //    this.allContent.css('display', 'block');
   //    this.allContent.css('visibility','visible');
	  // this.allContent.css('position','absolute');
  	//   this.allContent.css('width','100%');
